...
import { Shield, Zap, MapPin, Users, ChevronRight, Cpu, Play, Star, ExternalLink, Camera, BatteryCharging, Briefcase, Factory, Sparkles, ArrowRight } from 'lucide-react';
...
export const OlightPage: React.FC<PageProps> = ({ lang }) => {
   ...
   // Hero Images Slider
   const heroImages = [
       "https://cdn.olightstore.com/image/hwqjfb-1920x960-1-11-27x-k3s5ie.jpg", // Black Friday
       "https://cdn.olightstore.com/image/pc-1920x960-3840x1920-x-l64iv5.jpg", // Awards
       "https://cdn.olightstore.com/image/1920x960-5w4l56.jpg", // ArkPro
       "https://cdn.olightstore.com/image/01-st-banner-1920x960-pcd-1-at2hcv.jpg" // Marauder
   ];
         ...
         <section className="py-24 bg-[#050505] border-t border-[#222]">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                     <span className="text-olight-green font-bold tracking-widest uppercase text-xs mb-2 block">Cinematic Showcase</span>
                     <h2 className="text-3xl font-bold text-white uppercase">Experience Olight</h2>
                </div>
                <div className="max-w-5xl mx-auto relative aspect-video rounded-3xl overflow-hidden border border-[#333] shadow-2xl group">
                    <video 
                        src="https://wafisohswxqutsttotkb.supabase.co/storage/v1/object/public/Tek/Olight.mp4" 
